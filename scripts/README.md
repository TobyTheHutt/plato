...
- `check_vuln.sh` runs `govulncheck` in source and binary modes, deduplicates binary output against source results, applies Plato severity policy with override support, and can write optional JSON reports via `PLATO_VULN_REPORT_DIR`
